            ...
            <div class="dlshuru">
                <form action="LoginServlet" method="post">
                    <table>
                        ...
                        <tr class="dltext">
                            <td>管理员账号:</td>
                            <td><input type="text" class="form-control" placeholder="帐号" rows="1" name="EmployerId"></input></td>
                            <!--<td><input type="text" name="EmployerId" width="200px" ></td>-->
                        </tr>
                        <tr class="dltext">
                            <td>管理员密码:</td>
                            <td><input type="password" class="form-control" placeholder="密码" rows="1" name="Pwd"></input></td>
